...
public class MSControllerTest {
    ...
    public void testAddUserResourcePermissionValidInput() throws Exception {
        ...
        doNothing().when(resourcePermissionService).addUserResourcePermission(anyLong(), anyList());
        ...
        verify(resourcePermissionService).addUserResourcePermission(anyLong(), anyList());
    }

    // todo 待补充异常header情况
    // todo 待补充异常请求体情况

    // todo 待补充getResource方法单元测试
